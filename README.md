...
| 类别 | 示例 | 当前处理方式 |
| --- | --- | --- |
| AI 顶会 | NeurIPS / ICML / ICLR / AAAI | 维护 abstract、full paper、rebuttal 节点 |
| 期刊专刊 | Special issue / survey call | 记录投稿轮次和录用节点 |
| 科研项目 | grant / summer school / fellowship | 记录申请和材料提交截止 |
