...
[![Status](https://img.shields.io/badge/Status-topic%20scaffold-64748B?style=for-the-badge)](https://github.com/Just-Agent/academic-ddl)

[专题页面](https://just-agent.github.io/academic-ddl/) · [Just-DDL 总入口](https://just-agent.github.io/just-ddl/) · [GitHub 仓库](https://github.com/Just-Agent/academic-ddl) · [提交数据](https://github.com/Just-Agent/academic-ddl/issues)

</div>

## 项目定位

Academic-DDL 负责 AI / CS / Engineering / Science 等跨学科会议、期刊、基金、workshop 与投稿 deadline。它会作为独立仓库维护，拥有自己的 Pages 页面、数据 schema、Actions 更新流程和未来小程序专题入口。

## 产品入口

| 入口 | 地址 | 用途 |
| --- | --- | --- |
| GitHub Pages | https://just-agent.github.io/academic-ddl/ | 专题独立页面 |
| Just-DDL Hub | https://just-agent.github.io/just-ddl/ | 全部 DDL 专题总入口 |
| Repository | https://github.com/Just-Agent/academic-ddl | 代码、数据、工作流与贡献入口 |
| Issues | https://github.com/Just-Agent/academic-ddl/issues | 补充截止日、修正链接、申请数据源 |
...
| 类别 | 示例 | 当前处理方式 |
| --- | --- | --- |
| AI 顶会 | NeurIPS / ICML / ICLR / AAAI | 维护 abstract、full paper、rebuttal 节点 |`n| 期刊专刊 | Special issue / survey call | 记录投稿轮次和录用节点 |`n| 科研项目 | grant / summer school / fellowship | 记录申请和材料提交截止 |
